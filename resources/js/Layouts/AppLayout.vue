                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                                ...
                                <jet-dropdown align="right" width="60" v-if="$page.props.jetstream.hasTeamFeatures">
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md hover:bg-blue-400 focus:outline-none focus:bg-blue-500 dark:hover:bg-blue-600 dark:focus:bg-blue-700 transition">
                                    ...
                                    <template #content>
                                        <div class="w-60">
                                            ...
                                            <template v-if="$page.props.jetstream.hasTeamFeatures">
                                                <div class="block px-4 py-2 text-xs text-slate-500 dark:text-slate-200">
                                                    Manage Team
                                                </div>
                        ...
                        <div class="-mr-2 flex items-center sm:hidden">
                            <button @click="showingNavigationDropdown = ! showingNavigationDropdown" class="inline-flex items-center justify-center p-2 rounded-md hover:bg-blue-400 focus:outline-none focus:bg-blue-400 transition">
                    ...
                    <div class="pt-4 pb-1 border-t border-slate-200">
                        <div class="flex items-center px-4">
                            ...
                            <div>
                                ...
                                <div class="font-medium text-sm">{{ $page.props.user.email }}</div>
                            </div>
                        </div>
